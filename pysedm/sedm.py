...
MLA_CIRCLE = geometry.Point(980,1020).buffer(750)
...
def get_site_extinction():
    """ The ExtinctionSpectrum object of the Palomar/KP Extinction
    ...
    spec.create(lbda=SITE_EXTINCTION.T[0],data=SITE_EXTINCTION.T[1],
